...
* Reduce efforts of new user to generate password
* Cleaner look and feel of welcome email
* Completely 101% free
* Very light weight, no extra code added
* Zero setup efforts, Just install and activate

= Instant support =

I'm Anup, A full stack PHP Developer based in Delhi, India. I love open source community, if you are stuck anywhere while using this plugin or wants some customisation, please free to connect on me on instagram @ianup.nexgi

== Frequently Asked Questions ==

= How can I check plugin is working fine or not? =

Create a new user and check his email, If he is getting password with email (not reset link). Then plugin is working fine.

= What if I want to setup customise template (HTML Designed)? =

Currently this plugin sends a simple text based format as you can see the screenshots. But you can request us as paid to customise one for you.
